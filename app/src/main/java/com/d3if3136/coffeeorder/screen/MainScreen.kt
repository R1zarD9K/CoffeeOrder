...
import com.d3if3136.coffeeorder.navigation.Screen
import com.d3if3136.coffeeorder.ui.theme.CoffeeOrderTheme
import com.d3if3136.coffeeorder.util.SettingsDataStore
        ...
        floatingActionButton = {
            FloatingActionButton(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(id = R.string.add_order),
                    tint = MaterialTheme.colorScheme.primary
                )
            }
        }
...
fun GridItem(order: Order, onClick: () -> Unit) {
    Card(
        ...
        Column(
            ...
            Text(text = order.tanggal, fontWeight = FontWeight.Bold)
        }
    }
}
